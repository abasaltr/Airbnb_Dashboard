...
#################################################
# the api retrieves the data from listings_info for the heatmap analysis
...
#################################################
# the api retrieves the data from Cities and Nbh table for the drop downlist
...
#################################################
# the api retrieves the data from nbh_overview for the walkscore chart, heatmap analysis 
...
#################################################
# the api retrieves the data from Census_crime for the neighborhood facts section
...
# the api retrieves the data from nbh_overview for the crime statistics in neighborhood section
def crime_stats():
...
#################################################
# the api retrieves the data from listings_info, nbh_overview, nbh_Insights to get the statistical information 
# and the average rates information
...
#################################################
# the api retrieves the data from rental_rates_info to pull the rental_income, median_occupancy rates for 
# rentalrates vs occupancy chart chart based on rental size
...
###############################################
# the api retrieves the data from listing_info to pull the rental_income, median_occupancy rates for 
# Compare cleaning fee, nights booked, nightly rates chart
# rental income vs occupancy chart chart based on rental type
...
###############################################
# the api retrieves the data from nbh_insights for building the income score chart
...
#################################################
# the api retrieves the data from nbh_overview to get the neighborhood and county information for drop down list
...
#################################################
# the api retrieves the data from historical table for trend analysis
...
#################################################
# gets the houstonId for inital set up
@app.route("/api/getHoustonId")
def getHoustonId():
    results = db.session.query(Cities.city_id).filter(Cities.city == "Houston").scalar()
